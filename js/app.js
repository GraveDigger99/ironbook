(() => {
    ...
    function initSliders() {
        if (document.querySelector(".configurator__slider")) new core(".configurator__slider", {
        ...
        if (document.querySelector(".detail-info__slider")) new core(".detail-info__slider", {
    ...
    const showInfoBlock = e => {
        ...
        if (targetElement == targetElement.closest("[data-target]")) {
            ...
            if (targetElement.closest(".component-list")) {
                document.querySelector(".component-list").appendChild(block);
                document.querySelector(".overlay").style.opacity = "1";
                document.querySelector(".overlay").style.visibility = "visible";
                document.documentElement.classList.add("lock");
            }
            if (targetElement.closest(".content-processors")) {
                document.querySelector(".content-processors").appendChild(block);
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        if (pinWrapper) {
            ...
            var configuratorInner = document.querySelector(".body-configurator__inner");
            ...
            function handleScroll() {
                if (window.innerWidth >= 767.98) {
                    ...
                    var configuratorInnerBottom = configuratorInner.offsetTop + configuratorInner.offsetHeight;
                    var scrollPosition = window.scrollY;
                    if (scrollPosition >= pinBlockOffset && scrollPosition + (pinBlock.offsetHeight + 160) > configuratorInnerBottom) {
                        pinBlock.classList.remove("pinned");
                        pinBlock.style.position = "absolute";
                        pinBlock.style.bottom = "0";
                        placeholder.style.height = "0";
                    } else if (scrollPosition >= pinBlockOffset && scrollPosition + pinBlock.offsetHeight <= configuratorInnerBottom) {
    ...
    function initComputerBuilder() {
        ...
        function updatePerformance() {
            const selectedComponents = Array.from(document.querySelectorAll(".component.selected"));
        ...
        function showProgressContainer() {
            ...
            document.querySelector(".aside-configurator__result").style.display = "none";
            document.documentElement.style.setProperty("--progress", totalProgress);
            let updatedText = "";
            let updatedColor = "";
            for (const taskPercentage in tasks) if (totalProgress >= parseFloat(taskPercentage)) {
        ...
        function updateLinearProgressBar() {
            if (collectButtonClicked) {
                ...
                if (totalProgress === 0) {
                    ...
                    linearProgressBar.style.backgroundColor = getLinearProgressBarColor(totalProgress);
                }
            }
        }
        function getLinearProgressBarColor(progress) {
            if (collectButtonClicked) if (progress >= 100) return "#78b95d"; else if (progress >= 50) return "#ea9a3c"; else return "#fe3838";
            return "";
        }
